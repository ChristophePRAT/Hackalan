...
<p className="text-[0.75rem] text-[#B0B0BB] leading-relaxed text-center px-2">
                    ...
                    <div className="flex flex-col gap-2.5">
                        <button
                            onClick={() => { /* Generate audio functionality */ }}
                            className="w-full py-3.5 rounded-xl bg-[#5C58F6] hover:bg-[#4F4AD9] text-white text-[0.875rem] font-semibold transition-all duration-150 cursor-pointer flex items-center justify-center gap-2"
                        >
