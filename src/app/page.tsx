    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-20">
      ...
      <header className="fade-up text-center mb-12">
        <div className="inline-flex items-center gap-3 mb-7">
          <img src="/alan-logo.png" alt="Alan" className="h-12 w-auto" />
          <span className="font-extrabold text-[1.65rem] tracking-tight text-[#111117]">Mo Studios</span>
        </div>
        <h1 className="font-bold text-[2.75rem] leading-[1.1] tracking-tight text-[#111117]">
      ...
      {/* Progress bar */}
      {showProgress && (
        <div className={`w-full mb-10 fade-up ${isWide ? 'max-w-[860px]' : 'max-w-[560px]'}`}>
      ...
      {/* Step content */}
      <div key={step} className={`fade-up w-full ${isWide ? 'max-w-[860px]' : 'max-w-[560px]'}`}>
