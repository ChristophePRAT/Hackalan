...
export default function StepLoading({
    ...
    return (
        <div className="flex flex-col items-center text-center py-4">
            <div className="mb-14">
                <h2
                    className="font-bold leading-tight text-[2rem] mb-4"
                ...
                >
                    Every piece of content is medically vetted before being
                    shared.
                </p>
            </div>
                ...
                {STAGES.map((s, i) => {
                    ...
                    return (
                        ...
                        >
                            <div
                                ...
                                style={{
                                    ...
                                    border:
                                        i < stage
                                            ? "none"
                                            : `2px solid ${isCurrent ? "var(--color-alan-blue)" : "var(--color-alan-border)"}`,
                                }}
                            >
                                {i < stage && (
                                    <svg
                            ...
                            {isCurrent && (
                                <span
                                    className="ml-auto text-sm font-semibold uppercase tracking-wider animate-pulse"
                                    style={{ color: "var(--color-alan-blue)" }}
                                >
                                    In progress
                                </span>
                            )}
